					...
					<div className="testimonial-carousel-active">
						<Slider {...settings}>
							...
							<div className="single-testimoinal-item">
								...
								<div className="feedback">
									“As a geography enthusiast, 'Walk the World' has been a game-changer for me. The immersive experience and vast amount of information available have allowed me to explore the globe like never before..”
								</div>
								<div className="rating">
									<AiFillStar className="icon-star" />
									<AiFillStar className="icon-star" />
							...
							<div className="single-testimoinal-item">
								...
								<div className="feedback">
									“I travel frequently for work, and 'Walk the World' has become my go-to resource for learning about new destinations. The real-time updates keep me informed, and the interactive maps make planning my trips a breeze.”
								</div>
								<div className="rating">
									<AiFillStar className="icon-star" />
									<AiFillStar className="icon-star" />
